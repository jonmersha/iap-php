    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="user_dashboard.php">Audit Management System</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="find_registration.php"><i class="fa fa-plus fa-fw"></i> Finding Registration<span class="fa arrow"></span></a>

                        </li>
                        <li>
                            <a href="#"><i class="fa-solid fa fa-cart-plus"></i>&nbsp;Auditee Response</a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="auditee_response.php"><i class="fa-solid fa fa-comments"></i> Auditee Response</a>
                                </li>
                                <li>
                                    <a href="response.php"><i class="fa fa-reply-all"></i> Auditor Opinion Against Auditee Response</a>
                                </li>
                            </ul>
                        </li>
                        <li>
