...
if (!isset($user_role) || $user_role != '4') {
    session_unset();
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="engagement.php"><i class="fa fa-folder-open"></i>&nbsp; Audit Work/ Engagement<span class="fa arrow"></span></a>
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="modify_auditwork.php"><i class="fa fa-reply-all"></i>&nbsp; Modify Audit Program</a>
                                </li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="WBS.php"><i class="fa fa-reply-all"></i>&nbsp; WBS</a>
                                </li>
                                <li>
                        ...
                        <li>
                            <a href="view_team.php"><i class="fa fa-reply-all"></i>&nbsp; Temp/Team[Ad-hoc]<span class="fa arrow"></span></a>
                        </li>



                        <li>
                            <a href="find_registration.php"><i class="fa fa-briefcase"></i>&nbsp; &nbsp; Finding Registration<span class="fa briefcase"></span></a>
                        </li>
                        <li>
