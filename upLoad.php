...
if (isset($_POST['submit']) != "") {
    ...
    $move =  move_uploaded_file($temp, "upld/" . $fname);
    if ($move) {
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="dataTables-example">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <button class="alert-success"><a href="downLoad.php?filename=<?php echo $name; ?>&f=<?php echo $row['fname'] ?>"><i class="fa fa-download fw-fa"></i>&nbsp;Download</a></button>
                                </td>
                            </tr>
                        <?php } ?>
                    </table>
