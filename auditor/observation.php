         ...
         <div class="row">
             <div class="col-lg-10">
                 <?php
                    ...
                    ?>
                 <h5 class="page-header">General Observation</h5>
             </div>
             <!-- /.col-lg-12 -->
         </div>
             ...
             <div class="modal-content">
                 <form method="post" action="" enctype="multipart/form-data">
                     <div class="modal-header">
                         <h5 class="modal-title">General Observation</h5>
                     </div>
                     ...
                     <div class="modal-body">
                         ...
                         <div class="form-group">
                             ...
                             <div class="form-group">
                                 ...
                                 <!-- <input type="text" name="observation" class="form-control" placeholder="General observation by Auditor" required> -->
                                 <textarea name="observation" type="text" class="form-control"  required></textarea>
                             </div>
