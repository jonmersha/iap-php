                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <li>
                                    <a href="engagement.php"><i class="fa fa-reply-all"></i>&nbsp; View Engagement</a>
                                </li>    
                            <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="find_detail_reg.php"><i class="fa fa-check-square"></i>&nbsp; Finding Detail<span class=""></span></a>
                            </li>
                            <li>
