...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-10">
            ...
            ?>
            <h4 class="page-header">Work Breakdown </h4>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
            ...
            <form role="form" method="post">
                ...
                <section class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <?php
                        if (isset($saveReg['str_date'])) {
                            echo $saveReg['str_date'];
                        }
                        ?>
                    </div>
                </section>
                <section class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="date" name="en_date" class="form-control">
                        <?php
                        if (isset($saveReg['en_date'])) {
                            echo $saveReg['en_date'];
                        }
                        ?>
                    </div>
                </section>
