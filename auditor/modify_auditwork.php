...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-10">
            ...
            ?>
            <h5 class="page-header">Modify and Approval Audit Program</h5>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
                                                ...
                                                <form role="form" method="POST" action="#">
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="E_id" id="Objectives" class="form-control" value="<?php echo $RegValue['E_id'] ?>" placeholder="Enter Engagement Unique value">
