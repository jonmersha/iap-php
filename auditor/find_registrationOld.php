                    ...
                    <table class="table table-bordered" id="dataTables-exampleplc">
                        <thead>
                            <tr>
                                ...
                                <td>Acceptance Status/ Rectification</td>
                                <td>Auditor Name</td>
                                <td>Date</td>
                                <td>Action</td>
                                <td>Attachment</td>
            ...
            <form method="post" action="" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <label>Operational Area/ Category</label>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="recommendation" type="text" class="form-control"></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Rectification docs and related attachment</label>
                ...
                <div class="modal-footer">
                    <button type="submit" name="submit" class="btn btn-info"><i class="fa fa-upload fw-fa"></i> Register Findings and Upload</button>
