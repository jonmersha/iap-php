...
if (isset($_POST['create'])) {
    $save_team = $oms->add_quarter_summary($_POST);
}
...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-10">
            ...
            ?>
            <h5 class="page-header">QUARTER EXECUTIVE SUMMARY</h5>
    ...
    <div>
        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#form_modal"><span class="glyphicon glyphicon-plus"></span>Create Quarter Executive Summary</button>
        <!-- <a href="audit_type.php" class="badge badge-info"><span class="glyphicon glyphicon-plus"></span>Audit Type</a> &nbsp; &nbsp; -->
        <a href="auditee2.php" class="badge badge-info"><span class="glyphicon glyphicon-plus"></span>Auditee</a> &nbsp; &nbsp;
        <a href="Irregularity_type2.php" class="badge badge-info"><span class="glyphicon glyphicon-plus"></span>Irregularity Type</a> &nbsp; &nbsp;
