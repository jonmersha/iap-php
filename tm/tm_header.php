    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="tm_dashboard.php">Audit Management System</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="view_annualplan.php"><i class="fa fa-reply-all"></i>&nbsp; Annual Plan</a>
                                </li>
                                
                                <li>
                                    <a href="view_quarterplan.php"><i class="fa fa-reply-all"></i>&nbsp;Quarter Plan</a>
                                </li>
                                <li>
                                    <a href="view_monthlyplan.php"><i class="fa fa-reply-all"></i>&nbsp;Monthly Plan</a>
                                </li>
                        ...
                        <li>
                            <a href="engagement.php"><i class="fa fa-plus fa-fw"></i> Engagement/ Audit Work </a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-align-left"></i> &nbsp; Audit Program<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="Audit_program.php"><i class="fa fa-reply-all"></i>&nbsp; Prepare Audit Program</a>
                                </li>
                                <li>
                                    <a href="modify_auditwork.php"><i class="fa fa-reply-all"></i>&nbsp; Modify and Approval Audit Program</a>
                                </li>
                        ...
                        <li>
                            <a href="checklist.php"><i class="fa fa-plus fa-fw"></i> Checklist </a>
                        </li>
                        <li>
                            <a href=""><i class="fa fa-users"></i>&nbsp; Temporary Team <span class=""></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="temp_team.php"><i class="fa fa-reply-all"></i>&nbsp;Temporary Team/ Ad-hoc</a>
                                </li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="intro_letter.php"><i class="fa fa-reply-all"></i>&nbsp; Add Introduction Letter<span class=""></span></a>
                        ...
                        <li>
                            <a href="find_detail_reg.php"><i class="fa fa-reply-all"></i>&nbsp; Finding Detail</a>
                        </li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    ...
                                    <ul class="nav nav-third-level">
                                        <li>
                                            <a href="Quarter_summary.php"><i class="fa fa-reply-all"></i>&nbsp; Quarter Executive Summary Report</a>
                                        </li>
                                    </ul>
                                </li>
