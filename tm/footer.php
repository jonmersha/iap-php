...
<script type="text/javascript">
  CKEDITOR.replace('edO')
</script>
<script type="text/javascript">
  CKEDITOR.replace('edS')
</script>
<script type="text/javascript">
  CKEDITOR.replace('edPA')
</script>
<script type="text/javascript">
...
<script type="text/javascript">
  CKEDITOR.replace('editorlb')
</script>
<script type="text/javascript">
  CKEDITOR.replace('edx')
</script>
<script type="text/javascript">
  CKEDITOR.replace('Irregularity_ID')
</script>

<script type="text/javascript">
  CKEDITOR.replace('editoraap')
</script>
<script type="text/javascript">
  CKEDITOR.replace('editordet')
</script>
    ...
    if (str.length == 0) {
      ...
      xmlhttp.onreadystatechange = function() {
        ...
        if (this.readyState == 4 &&
          ...
          document.getElementById("auditee").value = myObj[0];

          // Assign the value received to
          // last name input field
          document.getElementById("Team").value = myObj[1];
        }
      };

      // xhttp.open("GET", "filename", true);
      xmlhttp.open("GET", "gfg.php?q_id=" + str, true);
...
<script type="text/javascript" language="javascript" >
 $(document).ready(function(){
   ...
   var dataTable = $('#Irregularity_type').DataTable({
    "processing" : true,
    "serverSide" : true,
    "order" : [],
    "ajax" : {
