...
$viewch = $oms->view_temp_team($_POST);
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-eg1">
                        <thead>
                            <tr>
                                ...
                                <th>Team Member</th>
                                <th>Auditor-in-Charge/Contact person</th>
                                <th>Audit Type</th>
                                <th>HO/Sub-process/Branches</th>
                                <th>Sub-process</th>
                                <th>Auditor Responsibilty/Description</th>
                                <!-- <th>Status</th> -->
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            ...
                                            if ($DeValue['status'] == "1")
                                                ...
                                                // green- activate
                                                echo
                                                "<a href=deactivate.php?id=" . $DeValue['id'] . " class='btn btn-danger btn-sm btn red'>Adjorn</a>";
                                            else
                                                echo
                                                "<a href=activate.php?id=" . $DeValue['id'] . "  class='btn btn-primary btn-sm btn green'>Activate</a>";
                                            ?>
                                                ...
                                                <form role="form" method="POST" action="#">
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="sub" id="sub" value="<?php echo $DeValue['sub'] ?>" class="form-control" placeholder="Enter sub process">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Auditor Responsibility/Description</label>
                                                            <input type="text" name="Description" id="Description" value="<?php echo $DeValue['Description'] ?>" class="form-control" placeholder="Enter detail auditor responsibility">
                                                        </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <select name="Team_member[]" class="form-control multiple-select" multiple="multiple">
                                <option value="">--- Select ---</option>
                                <?php
