        ...
        <div class="col-sm-10">
            <form role="form" method="post">
                <div class="form-group">
                    ...
                    <textarea name="intro" type="text" class="form-control" id="editor"></textarea>
                </div>
                <div class="form-group">
                    <label>Audit Objective</label>
                    <textarea name="objective" type="text" class="form-control" class="form-control" id="editor1"></textarea>
                </div>
                <div class="form-group">
                    <label>Audit Methodology</label>
                    <textarea name="methodology" type="text" class="form-control" class="form-control" id="editor2"></textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea name="summary" type="text" class="form-control" id="editor3"></textarea>
                </div>
