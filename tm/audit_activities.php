...
if (isset($_POST['submit'])) {
    ...
    $saveReg = $oms->aud_activies($_POST);
}
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-10">
            ...
            ?>
            <h4 class="page-header">New Audit Object</h4>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-sm-10">
            ...
            <form role="form" method="post">
                <div class="form-group">
                    ...
                    <input type="text" name="audit_activities" class="form-control" required>
                    <?php
                    if (isset($saveReg['audit_activities'])) {
                        echo $saveReg['audit_activities'];
                    }
                    ?>
                </div>
