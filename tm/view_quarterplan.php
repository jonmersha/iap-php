                                                ...
                                                <form role="form" method="POST" action="#">
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <label>Annual Plan ID:</label><?php echo $RegValue['a_id'] ?>
                                                        </div>
                                                        <div class="form-group">
                                                ...
                                                <div class="modal-header">
                                                    ...
                                                    <form role="form" method="POST" action="#">
                                                        <div class="modal-body">
                                                            ...
                                                            <!-- <div class="form-group">
                                                                <label>Auditee</label>
                                                                <input type="text" name="auditee" id="auditee" class="form-control" value="<?php echo $RegValue['auditee'] ?>" placeholder="Edit Auditee">
