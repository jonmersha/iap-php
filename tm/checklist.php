                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td><?php echo $chValue['audit_approach']; ?></td>
                                                    ...
                                                    <form role="form" method="POST" action="#">
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="checklist_number" id="checklist_number" class="form-control" value="<?php echo $chValue['checklist_number'] ?>" placeholder="Enter checklist number">
            ...
            <form method="post" action="#">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <label>Expected Control</label>
                            <textarea name="expected_control" type="text" class="form-control" id="editor"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Audit Approach</label>
