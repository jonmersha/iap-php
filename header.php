                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="view-annual-plan.php"><i class="fa fa-reply-all"></i>&nbsp; Annual Plan</a>
                                </li>
                                <li>
                                    <a href="view_quarter.php"><i class="fa fa-reply-all"></i>&nbsp;Quarter Plan</a>
                                </li>
                                <li>
                                    <a href="view_monthly.php"><i class="fa fa-reply-all"></i>&nbsp;Monthly Plan</a>
                                </li>
                        ...
                        <li>
                            <a href="logM.php"><i class="fa fa-reply-all"></i>&nbsp;Activity log</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
